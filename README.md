...
The code for this step is contained in `1. Camera Calibration` and `2. Distortion Correction` Section of the IPython notebook [Advanced-Lane-Lines.ipynb](Advanced-Lane-Lines.ipynb).  
